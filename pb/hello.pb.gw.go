...
/*
Package helloService is a reverse proxy.
...
func request_Hello_ServerStreamPing_0(ctx context.Context, marshaler runtime.Marshaler, client HelloClient, req *http.Request, pathParams map[string]string) (Hello_ServerStreamPingClient, runtime.ServerMetadata, error) {
	...
	stream, err := client.ServerStreamPing(ctx, &protoReq)
	if err != nil {
...
func RegisterHelloHandlerServer(ctx context.Context, mux *runtime.ServeMux, server HelloServer) error {
	...
	mux.Handle("POST", pattern_Hello_Hello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/helloService.Hello/Hello", runtime.WithHTTPPathPattern("/v1/example/hello"))
		if err != nil {
	...
	mux.Handle("POST", pattern_Hello_ServerStreamPing_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterHelloHandlerClient(ctx context.Context, mux *runtime.ServeMux, client HelloClient) error {
	...
	mux.Handle("POST", pattern_Hello_Hello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/helloService.Hello/Hello", runtime.WithHTTPPathPattern("/v1/example/hello"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_Hello_ServerStreamPing_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/helloService.Hello/ServerStreamPing", runtime.WithHTTPPathPattern("/v1/example/hello-server-stream"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Hello_ServerStreamPing_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_Hello_ServerStreamPing_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Hello_Hello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "example", "hello"}, ""))

	pattern_Hello_ServerStreamPing_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "example", "hello-server-stream"}, ""))
)

var (
	forward_Hello_Hello_0 = runtime.ForwardResponseMessage

	forward_Hello_ServerStreamPing_0 = runtime.ForwardResponseStream
)
